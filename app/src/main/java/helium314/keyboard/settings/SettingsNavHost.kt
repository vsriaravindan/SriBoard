...
import helium314.keyboard.ai.AiSettingsScreen
    ...
    NavHost(
        ...
        composable(SettingsDestination.Settings) {
            MainSettingsScreen(
                ...
                onClickAiSettings = { navController.navigate(SettingsDestination.AiSettings) },
                onClickBack = ::goBack,
            )
        }
        composable(SettingsDestination.AiSettings) {
